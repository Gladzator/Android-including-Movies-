...
public class LoginContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        //directory
        uriMatcher.addURI(LoginContract.AUTHORITY, LoginContract.PATH_TASKS, TASKS);
        //single item
        uriMatcher.addURI(LoginContract.AUTHORITY, LoginContract.PATH_TASKS + "/#", TASKS_WITH_ID);

        return uriMatcher;
    }

    LoginDbHelper mTaskDbHelper;
    ...
    public boolean onCreate() {
        ...
        mTaskDbHelper = new LoginDbHelper(context);
        return true;
    }
