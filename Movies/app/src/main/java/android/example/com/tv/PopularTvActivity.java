...
public class PopularTvActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(PopularTvActivity.this,
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (spinner.getSelectedItem().toString().equals("Top Rated")) {
                    Intent intent = new Intent(PopularTvActivity.this, TopRatedTvActivity.class);
                    ActivityCompat.finishAffinity(PopularTvActivity.this);
                    startActivity(intent);
                }
                if (spinner.getSelectedItem().toString().equals("Airing Today")) {
                    Intent intent = new Intent(PopularTvActivity.this, AiringTodayTvActivity.class);
                    ActivityCompat.finishAffinity(PopularTvActivity.this);
                    startActivity(intent);
                }
                if (spinner.getSelectedItem().toString().equals("On Air")){
                    Intent intent = new Intent(PopularTvActivity.this, OnAirTvActivity.class);
                    ActivityCompat.finishAffinity(PopularTvActivity.this);
                    startActivity(intent);
                }
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_movie:
                        Intent intent = new Intent(PopularTvActivity.this, MainActivity.class);
                        ActivityCompat.finishAffinity(PopularTvActivity.this);
                        startActivity(intent);
                        break;
                    case R.id.nav_tv:
        ...
        searchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            ...
            public void onSearchViewClosed() {
                ...
                adapter = new PopularTvArrayAdapter(popularMovieLists, PopularTvActivity.this);
        ...
        layoutManager = new GridLayoutManager(PopularTvActivity.this, numberOfColumns);
        ...
        if (isConnected(PopularTvActivity.this)) {
            new CheckConnectionStatus().execute("https://api.themoviedb.org/3/tv/popular?api_key=f7df3696efcc5684f0e5e7b7da66c88f");
        }else {
    ...
    public void onsearch(String newText){
        if(newText!=null && !newText.isEmpty()) {
            ...
            adapter = new PopularTvArrayAdapter(listfound,PopularTvActivity.this);
            popularView.setAdapter(adapter);
        }else{
