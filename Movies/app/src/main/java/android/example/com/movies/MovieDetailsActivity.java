...
public class MovieDetailsActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        details= (PopularMovieDetails) getIntent().getExtras().getSerializable("MOVIE_DETAILS");

        if (isConnected(MovieDetailsActivity.this)) {
            new CheckConnectionStatus().execute("http://api.themoviedb.org/3/movie/"+String.valueOf(details.getId())+"/videos?api_key=f7df3696efcc5684f0e5e7b7da66c88f");
        }else {
