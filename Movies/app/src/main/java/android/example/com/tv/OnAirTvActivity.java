...
public class OnAirTvActivity extends AppCompatActivity{
    //TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(OnAirTvActivity.this,
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (spinner.getSelectedItem().toString().equals("Top Rated")) {
                    Intent intent = new Intent(OnAirTvActivity.this, TopRatedTvActivity.class);
                    ActivityCompat.finishAffinity(OnAirTvActivity.this);
                    startActivity(intent);
                }
                if (spinner.getSelectedItem().toString().equals("Popular")) {
                    Intent intent = new Intent(OnAirTvActivity.this, PopularTvActivity.class);
                    ActivityCompat.finishAffinity(OnAirTvActivity.this);
                    startActivity(intent);
                }
                if (spinner.getSelectedItem().toString().equals("Airing Today")) {
                    Intent intent = new Intent(OnAirTvActivity.this, AiringTodayTvActivity.class);
                    ActivityCompat.finishAffinity(OnAirTvActivity.this);
                    startActivity(intent);
                }
            }
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_movie:
                        Intent intent = new Intent(OnAirTvActivity.this, MainActivity.class);
                        ActivityCompat.finishAffinity(OnAirTvActivity.this);
                        startActivity(intent);
                        break;
                    case R.id.nav_tv:
        ...
        searchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            ...
            public void onSearchViewClosed() {
                ...
                adapter = new PopularTvArrayAdapter(popularMovieLists, OnAirTvActivity.this);
        ...
        layoutManager = new GridLayoutManager(OnAirTvActivity.this, numberOfColumns);
        ...
        if (isConnected(OnAirTvActivity.this)) {
            new CheckConnectionStatus().execute("https://api.themoviedb.org/3/tv/on_the_air?api_key=f7df3696efcc5684f0e5e7b7da66c88f");
        }else {
    ...
    public void onsearch(String newText){
        if(newText!=null && !newText.isEmpty()) {
            ...
            adapter = new PopularTvArrayAdapter(listfound,OnAirTvActivity.this);
            popularView.setAdapter(adapter);
        }else{
