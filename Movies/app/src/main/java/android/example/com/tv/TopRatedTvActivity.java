...
import android.example.com.tv.PopularTvArrayAdapter;
...
import android.example.com.movies.UpcomingMovieActivity;
...
public class TopRatedTvActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter=new ArrayAdapter<String>(TopRatedTvActivity.this,
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (spinner.getSelectedItem().toString().equals("Popular")){
                    Intent intent=new Intent(TopRatedTvActivity.this,PopularTvActivity.class);
                    ActivityCompat.finishAffinity(TopRatedTvActivity.this);
                    startActivity(intent);
                }
                if (spinner.getSelectedItem().toString().equals("Airing Today")){
                    Intent intent=new Intent(TopRatedTvActivity.this,AiringTodayTvActivity.class);
                    ActivityCompat.finishAffinity(TopRatedTvActivity.this);
                    startActivity(intent);
                }
                if (spinner.getSelectedItem().toString().equals("On Air")) {
                    Intent intent = new Intent(TopRatedTvActivity.this, OnAirTvActivity.class);
                    ActivityCompat.finishAffinity(TopRatedTvActivity.this);
                    startActivity(intent);
                }
            }
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_movie:
                        Intent intent=new Intent(TopRatedTvActivity.this,MainActivity.class);
                        ActivityCompat.finishAffinity(TopRatedTvActivity.this);
                        startActivity(intent);
                        break;
                    case R.id.nav_tv:
        ...
        searchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            ...
            public void onSearchViewClosed() {
                ...
                adapter = new PopularTvArrayAdapter(popularMovieLists, TopRatedTvActivity.this);
        ...
        layoutManager = new GridLayoutManager(TopRatedTvActivity.this, numberOfColumns);
        ...
        if (isConnected(TopRatedTvActivity.this)) {
            new CheckConnectionStatus().execute("https://api.themoviedb.org/3/tv/top_rated?api_key=f7df3696efcc5684f0e5e7b7da66c88f");
        }else {
    ...
    public void onsearch(String newText){
        if(newText!=null && !newText.isEmpty()) {
            ...
            adapter = new PopularTvArrayAdapter(listfound,TopRatedTvActivity.this);
            popularView.setAdapter(adapter);
        }else{
