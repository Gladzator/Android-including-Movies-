...
public class UpcomingMovieActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter=new ArrayAdapter<String>(UpcomingMovieActivity.this,
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (spinner.getSelectedItem().toString().equals("Now Playing")){
                    Intent intent=new Intent(UpcomingMovieActivity.this,MainActivity.class);
                    ActivityCompat.finishAffinity(UpcomingMovieActivity.this);
                    startActivity(intent);
                }
                if (spinner.getSelectedItem().toString().equals("Top Rated")){
                    Intent intent=new Intent(UpcomingMovieActivity.this,TopRatedMovieActivity.class);
                    ActivityCompat.finishAffinity(UpcomingMovieActivity.this);
                    startActivity(intent);
                }
            }
        ...
        searchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            ...
            public void onSearchViewClosed() {
                ...
                adapter = new PopularMovieArrayAdapter(popularMovieLists, UpcomingMovieActivity.this);
        ...
        layoutManager = new GridLayoutManager(UpcomingMovieActivity.this, numberOfColumns);
        ...
        if (isConnected(UpcomingMovieActivity.this)) {
            new CheckConnectionStatus().execute("https://api.themoviedb.org/3/movie/upcoming?api_key=f7df3696efcc5684f0e5e7b7da66c88f");
        }else {
    ...
    public void onsearch(String newText){
        if(newText!=null && !newText.isEmpty()) {
            ...
            adapter = new PopularMovieArrayAdapter(listfound,UpcomingMovieActivity.this);
            popularView.setAdapter(adapter);
        }else{
