...
public class TopRatedMovieActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter=new ArrayAdapter<String>(TopRatedMovieActivity.this,
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (spinner.getSelectedItem().toString().equals("Now Playing")){
                    Intent intent=new Intent(TopRatedMovieActivity.this,MainActivity.class);
                    ActivityCompat.finishAffinity(TopRatedMovieActivity.this);
                    startActivity(intent);
                }
                if (spinner.getSelectedItem().toString().equals("Upcoming")){
                    Intent intent=new Intent(TopRatedMovieActivity.this,UpcomingMovieActivity.class);
                    ActivityCompat.finishAffinity(TopRatedMovieActivity.this);
                    startActivity(intent);
                }
            }
        ...
        searchView.setOnSearchViewListener(new MaterialSearchView.SearchViewListener() {
            ...
            public void onSearchViewClosed() {
                ...
                adapter = new PopularMovieArrayAdapter(popularMovieLists, TopRatedMovieActivity.this);
        ...
        layoutManager = new GridLayoutManager(TopRatedMovieActivity.this, numberOfColumns);
        ...
        if (isConnected(TopRatedMovieActivity.this)) {
            new CheckConnectionStatus().execute("https://api.themoviedb.org/3/movie/top_rated?api_key=f7df3696efcc5684f0e5e7b7da66c88f");
        }else {
    ...
    public void onsearch(String newText){
        if(newText!=null && !newText.isEmpty()) {
            ...
            adapter = new PopularMovieArrayAdapter(listfound,TopRatedMovieActivity.this);
            popularView.setAdapter(adapter);
        }else{
