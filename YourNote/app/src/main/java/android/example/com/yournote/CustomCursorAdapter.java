...
import android.example.com.data.NoteContract;
...
public class CustomCursorAdapter extends RecyclerView.Adapter<CustomCursorAdapter.TaskViewHolder> {
    ...
    public TaskViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new TaskViewHolder(view,mContext);
    }
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        int noteIndex = mCursor.getColumnIndex(COLUMN_NOTE);

        mCursor.moveToPosition(position); // get to the right location in the cursor

        // Determine the values of the wanted data
        final int id = mCursor.getInt(idIndex);
        String notedata = mCursor.getString(noteIndex);
    ...
    class TaskViewHolder extends RecyclerView.ViewHolder  implements  View.OnClickListener{
         ...
         */
        public TaskViewHolder(View itemView,Context mContext) {
            super(itemView);
            this.mContext=mContext;
            itemView.setOnClickListener(this);
            NoteData = (TextView) itemView.findViewById(R.id.noteDescription);
        }
        ...
        public void onClick(View view) {
            ...
            String m=mCursor.getString(mCursor.getColumnIndex(COLUMN_NOTE));

            Intent intent=new Intent(this.mContext,AddNoteActivity.class);
